...
import { Card, CardContent, CardHeader,IconButton, Typography,Tooltip, CardMedia, Chip } from '@mui/material';
        ...
        <div style={style.feed}>
            <Card sx={{ maxWidth: 345 }}>
                ...
                <CardContent>
                    ...
                    {props.product.stock === 0 ? <Chip label="Sin stock"/> : <Chip label="En stock"/>}
                    </Tooltip>
                </CardContent>
            </Card>
        </div>
